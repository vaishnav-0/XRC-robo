...
const onButtonMD = (event: any) => {
    if (event.target.id === "btn-a") {
        sendControl('a');
    } else if (event.target.id === "btn-w") {

        sendControl('w');
    } else if (event.target.id === "btn-d") {

        sendControl('d');
    } else if (event.target.id === "btn-s") {
...
if (mobileCheck()) {
    ["btn-a", "btn-w", "btn-s", "btn-d"].map((b) => {
        console.log(b)
        document.getElementById(b)?.addEventListener("touchstart", onButtonMD);
        document.getElementById(b)?.addEventListener("touchend", onButtonMU);

    });
} else {
    ["btn-a", "btn-w", "btn-s", "btn-d"].map((b) => {
        console.log(b)
        document.getElementById(b)?.addEventListener("mousedown", onButtonMD);
        document.getElementById(b)?.addEventListener("mouseup", onButtonMU);
